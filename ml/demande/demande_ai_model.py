...
import demande_adaptive_model as autre_engine
...
def _build_autre_response(request_data, prompt):
    ...
    delegated_payload = dict(request_data or {})
    delegated_payload["text"] = source
    delegated_payload["prompt"] = source
    return autre_engine.generate_autre_response(delegated_payload)
