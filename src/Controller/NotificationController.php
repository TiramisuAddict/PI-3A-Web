...
/** CRUD des notifications utilisateur. */
#[Route('/notification')]
final class NotificationController extends AbstractController
{
    ...
    #[Route('/{id_notification}', name: 'app_notification_show', methods: ['GET'])]
    ...
    #[Route('/{id_notification}/edit', name: 'app_notification_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id_notification}', name: 'app_notification_delete', methods: ['POST'])]
